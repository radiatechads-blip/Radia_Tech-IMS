...
async function main() {
  ...
  const adminUsers = [
    ...
    process.env.EXTRA_ADMIN_EMAIL && process.env.EXTRA_ADMIN_PASSWORD
      ? {
          ...
          name: "Radiatech Admin",
        }
      : null,
  ].filter(
    (
      adminUser,
    ): adminUser is { email: string; password: string; name: string } =>
      Boolean(adminUser),
  );
  ...
  const categoryData = [
    {
      ...
      name: "PPR Pipes",
      description:
        "Premium quality PPR-C pipes available in sizes from 20MM to 615 mm with pressure ratings from PN 6 to PN 20.",
    ...
    },
    {
      ...
      description:
        "Complete range of PPR pipe fittings including elbows, tees, couplers, clamps, and reducers.",
    ...
    },
    {
      ...
      name: "PPRC Fittings",
      description:
        "Industrial-grade PPRC fittings for large diameter piping systems in industrial and process applications.",
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (1).jpeg",
      sortOrder: 3,
    },
    {
      slug: "pipes-fittings",
      name: "Pipes & Fittings",
      description:
        "General-purpose pipes and fittings for construction and plumbing applications.",
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (2).jpeg",
      sortOrder: 4,
    },
    {
      ...
      description:
        "Specialized piping solutions for compressed air, nitrogen, oxygen, and vacuum line applications.",
    ...
    },
    {
      ...
      description:
        "End-to-end industrial piping installation, lining, and maintenance services.",
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.21 PM (1).jpeg",
      sortOrder: 6,
    },
  ];
  ...
  const productData = [
    {
      slug: "fusion-ppr-pipes",
      name: "Fusion PPR Pipes",
      catSlug: "ppr-pipes",
      description:
        "High-quality Fusion PPR pipes designed for industrial and commercial applications.",
      specs: {
    ...
    {
      slug: "fusion-ppr-pipe-pn16",
      name: "Fusion PPR Pipe PN 16 Waterline Special",
      catSlug: "ppr-pipes",
      description:
        "Specialized PN 16 rated PPR pipes designed specifically for waterline applications.",
      specs: {
    ...
    {
      slug: "green-therm-ppr-pipes",
      name: "Green Therm PPR Pipes",
      catSlug: "ppr-pipes",
      description:
        "Premium Green Therm PPR pipes with enhanced thermal properties.",
      specs: {
    ...
    {
      slug: "fusion-ppr-pipes-standard",
      name: "Fusion PPR Pipes - Standard Range",
      catSlug: "ppr-pipes",
      description:
        "Standard range Fusion PPR pipes for general-purpose industrial piping.",
      specs: {
        Material: "PPR-C",
    ...
    },
    {
      ...
      catSlug: "ppr-pipe-fittings",
      description:
        "High-quality PPR reducing tee fitting for transitioning between different pipe sizes.",
      specs: {
        Size: "63MM x 50MM",
        Material: "PPR-C",
        Type: "Reducing Tee",
      ...
      apps: ["Pipeline Branching", "Size Reduction", "Industrial Piping"],
      image: "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM.jpeg",
    },
    {
      slug: "fusion-pprc-elbow-50mm",
      name: "Fusion PPRC Elbow 50MM",
      catSlug: "ppr-pipe-fittings",
      description:
        "50MM PPRC elbow fitting for directional changes in piping systems.",
      specs: {
        Size: "50MM",
        Material: "PPRC",
        Angle: "90°",
      ...
      apps: ["Direction Change", "Pipeline Routing", "Industrial Systems"],
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (1).jpeg",
    },
    {
      slug: "fusion-ppr-coupler",
      name: "Fusion PPR Coupler",
      catSlug: "ppr-pipe-fittings",
      description:
        "Standard PPR coupler for joining two pipes of the same diameter.",
      specs: {
      ...
      apps: ["Pipe Joining", "Extension", "Repair"],
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (2).jpeg",
    },
    {
      ...
      catSlug: "ppr-pipe-fittings",
      description:
        "Blue PPR tee fitting for creating three-way junctions in pipeline systems.",
      specs: {
        Material: "PPR-C",
        Color: "Blue",
        Type: "Equal Tee",
    ...
    },
    {
      ...
      catSlug: "ppr-pipe-fittings",
      description: "PPR pipe clamps for secure pipe mounting and support.",
      specs: {
        "Size Range": "20MM to 63MM",
        Material: "PPR-C",
        Type: "Pipe Clamp / Support",
      },
      apps: ["Pipe Mounting", "Wall Support", "Overhead Piping"],
      image: "/images/projects/WhatsApp Image 2026-04-17 at 12.17.21 PM.jpeg",
    },
    {
      slug: "pprc-coupler",
      name: "PPRC Coupler",
      catSlug: "pprc-fittings",
      description: "Premium PPRC coupler for joining PPRC pipes.",
      specs: {
        Material: "PPRC",
        Connection: "Fusion Welding",
        Standard: "DIN 16962",
      },
      apps: ["Industrial Piping", "Water Supply", "Chemical Lines"],
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (2).jpeg",
    },
    {
      slug: "pprc-pipe-fittings-6inch",
      name: "PPRC Pipe Fittings 6 inch Elbow",
      catSlug: "pprc-fittings",
      description:
        "6-inch PPRC elbow fitting for large-diameter piping systems.",
      specs: {
        Size: "6 inch",
        Type: "Elbow",
        Material: "PPRC",
      ...
      apps: ["Water Supply", "Industrial Piping", "Construction"],
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (1).jpeg",
    },
    {
      slug: "pprc-pipe-fittings-34",
      name: "3/4 inch PPRC Pipe & Fittings",
      catSlug: "pprc-fittings",
      description:
        "3/4 inch PPRC pipe and fittings for construction and plumbing.",
      specs: {
        Size: "3/4 inch",
        Type: "Pipe & Elbow",
        Material: "PPRC",
      ...
      apps: ["Construction", "Plumbing", "Residential"],
      image: "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM.jpeg",
    },
    {
      slug: "pprc-flange-fusion",
      name: "PPRC Flange (Fusion)",
      catSlug: "pprc-fittings",
      description:
        "Fusion-type PPRC flange for connecting PPRC piping to metal piping.",
      specs: {
        Material: "PPRC",
        Type: "Fusion Flange",
    ...
    {
      slug: "fusion-pprc-reducer",
      name: "Fusion PPRC Reducer",
      catSlug: "pprc-fittings",
      description:
        "PPRC reducer for transitioning between different pipe diameters.",
      specs: {
        Material: "PPRC",
        Type: "Reducer",
        Connection: "Fusion Welding",
      },
      apps: ["Size Transition", "Flow Management", "Industrial Piping"],
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (2).jpeg",
    },
    {
      slug: "industrial-piping-work",
      name: "Industrial Piping Work for Air/Chemical/Vacuum Line",
      catSlug: "compressed-air-pipe-fittings",
      description:
        "Complete industrial piping solutions for compressed air lines, chemical supply lines, vacuum lines.",
      specs: {
    ...
    {
      slug: "pprc-ball-valve",
      name: "PPRC Ball Valve",
      catSlug: "pprc-fittings",
      description:
        "High-quality PPRC ball valve for flow control in piping systems.",
      specs: {
        Material: "PPRC",
        Type: "Ball Valve",
        Operation: "Manual",
      ...
      apps: ["Flow Control", "Shut-off", "Process Control"],
      image: "/images/projects/WhatsApp Image 2026-04-17 at 12.17.25 PM.jpeg",
      isNew: true,
    },
    {
      slug: "mta-male-threaded-adaptor",
      name: "MTA Male Threaded Adaptor",
      catSlug: "pprc-fittings",
      description:
        "Male threaded adaptor for connecting PPRC piping to threaded metal fittings.",
      specs: {
    ...
    },
    {
      ...
      catSlug: "pprc-fittings",
      description:
        "50MM Female Threaded Adaptor (FTA) for connecting PPRC piping to threaded components.",
      specs: {
        Size: "50MM",
        Material: "PPRC + Brass Insert",
    ...
    {
      slug: "pprc-tank-nipple",
      name: "PPRC Tank Nipple",
      catSlug: "pprc-fittings",
      description:
        "PPRC tank nipple for connecting piping systems to tanks and vessels.",
      specs: { Material: "PPRC", Type: "Tank Nipple", Seal: "Waterproof" },
      apps: ["Tank Connection", "Vessel Interface", "Water Storage"],
      image:
        "/images/projects/WhatsApp Image 2026-04-17 at 12.17.20 PM (2).jpeg",
      isNew: true,
    },
