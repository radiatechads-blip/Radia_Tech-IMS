          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-nowrap overflow-x-auto whitespace-nowrap scrollbar-none min-w-0">
            ...
            <span className="flex">
              <a
                ...
                className="flex items-center gap-1 hover:text-red-200 transition-colors shrink-0"
              >
                <Phone size={14} />
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-1 hover:text-red-200 transition-colors shrink-0"
            >
              <Mail size={14} />
                          ...
                          {productLinks
                            ...
                            .map((link) => (
                              <Link
                                key={link.href}
                                href={link.href}
                                className="text-sm text-gray-600 hover:text-red-600 hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap"
                              >
                                {link.label}
                              </Link>
                            ))}
