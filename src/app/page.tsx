...
export default async function HomePage() {
  ...
  <div className="absolute inset-0">
    <Image
      ...
      priority
    />
    {/* Gradient adjusted to show more of the image on the right */}
    <div className="absolute inset-0 bg-gradient-to-r from-[#0f172a] via-[#0f172a]/40 to-transparent" />
  </div>

  <div className="relative max-w-7xl mx-auto px-4 py-20 lg:py-32 flex flex-col lg:flex-row items-center gap-12">
    
    {/* LEFT: Content */}
    <div className="flex-1 space-y-8 z-10">
      <h1 className="text-4xl lg:text-6xl font-extrabold leading-tight">
        COMPLETE <span className="text-red-600">FIRE & SAFETY</span> SOLUTIONS UNDER ONE ROOF
      </h1>
      
      <p className="text-lg text-gray-300 max-w-xl">
        We provide end-to-end fire protection solutions from design to commissioning with unmatched quality and reliability.
      </p>
      ...
      <div className="grid grid-cols-2 gap-4 max-w-md">
        {[
          ...
          <div key={item.label} className="border border-white/10 p-4 rounded-xl flex flex-col items-center text-center gap-3 bg-white/5 hover:border-red-600/50 transition-colors">
      ...
      <div className="flex flex-wrap gap-4">
        <Link href="/contact" className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-lg font-bold transition-all shadow-lg shadow-red-600/20">
          GET A QUOTE
        </Link>
        <Link href="/projects" className="bg-transparent border border-white hover:bg-white hover:text-black px-8 py-4 rounded-lg font-bold transition-all">
          VIEW PROJECTS
        </Link>
      </div>
    </div>

    {/* RIGHT: Functional Action Bar */}
    <div className="hidden lg:flex flex-col items-center bg-red-600 py-8 px-4 rounded-l-2xl text-white gap-6 absolute right-0 top-1/2 -translate-y-1/2 shadow-2xl z-20">
      <a href={`tel:${companyInfo.contact.phoneHref}`} className="flex flex-col items-center gap-1 hover:text-red-200 transition-colors" title="Call Us">
        <Phone size={24} />
        <span className="text-[10px] font-bold uppercase">Call</span>
      </a>
      <a href={`https://wa.me/${companyInfo.contact.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 hover:text-red-200 transition-colors" title="Chat on WhatsApp">
        <MessageCircle size={24} />
        <span className="text-[10px] font-bold uppercase">Chat</span>
      </a>
      <Link href="/contact" className="flex flex-col items-center gap-2 hover:text-red-200 transition-colors border-t border-red-500 pt-6" title="Request Consultation">
        <span className="[writing-mode:vertical-rl] rotate-180 font-bold tracking-widest text-xs">
          CONSULT
        </span>
        <Calendar size={20} />
      </Link>
  ...
  <div className="max-w-7xl mx-auto px-4">
    <div className="flex flex-wrap items-center justify-between gap-6">
      {companyInfo.statsItems.map((stat, index) => {
        ...
        return (
          <div key={stat.label} className="flex items-center gap-4 flex-1 min-w-[200px]">
            {/* Icon */}
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    {/* Section Header */}
    <div className="text-center mb-20">
      <h2 className="text-4xl font-extrabold text-gray-900 mb-6">OUR FIRE SAFETY PROCESS</h2>
      <div className="h-1.5 w-24 bg-red-600 mx-auto" />
    </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    {/* Header */}
    <div className="text-center mb-16">
      <h2 className="text-4xl font-extrabold text-gray-900 mb-4">FIRE SAFETY SOLUTIONS</h2>
      <div className="h-1.5 w-24 bg-red-600 mx-auto mb-6" />
      <p className="text-gray-600 max-w-lg mx-auto">
        Advanced fire protection systems engineered for industrial compliance and maximum safety.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      {[
        { 
          ...
          items: ["Hydrant Network", "Sprinkler Systems", "Deluge Valves", "Water Curtain", "Fire Pumps"] 
        },
        { 
          title: "GAS & FOAM SUPPRESSION", 
          items: ["CO2 Flooding Systems", "Clean Agent Systems", "Foam Generators", "Foam Monitors", "Kitchen Hood Systems"] 
        },
        { 
          title: "DETECTION & ALARM", 
          items: ["Smoke Detectors", "Heat Sensors", "Manual Call Points", "Control Panels", "Public Address Systems"] 
        },
        { 
          title: "PASSIVE FIRE SAFETY", 
          items: ["Fire Rated Doors", "Fire Proofing", "Smoke Curtains", "Signage Systems", "Emergency Lighting"] 
        },
      ].map((app) => (
        <div
          key={app.title}
...
<div className="text-red-600 mb-6 group-hover:scale-110 transition-transform">
  {app.title === "WATER-BASED PROTECTION" && <Droplets size={48} strokeWidth={1.5} />}
  {app.title === "GAS & FOAM SUPPRESSION" && <Flame size={48} strokeWidth={1.5} />}
  {app.title === "DETECTION & ALARM" && <Bell size={48} strokeWidth={1.5} />}
  {app.title === "PASSIVE FIRE SAFETY" && <Shield size={48} strokeWidth={1.5} />}
</div>
          </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      <div className="text-white">
        <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
          ...
          <span className="text-red-600">Fire Safety Infrastructure?</span>
        </h2>
        <p className="text-gray-200 mb-8 text-lg">
          Get a professional consultation and custom safety audit. 
          Our experts provide comprehensive fire protection solutions 
