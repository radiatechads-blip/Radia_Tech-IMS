...
<html>
  ...
  const totalLabelMap: Record<DocumentType, string> = {
    ...
    "Debit Note": "Total Debit Note",
    "Credit Note": "Total Credit Note",
    ...
    "Delivery Challan": "Total Delivery Challan",
  ...
  const totalColorMap: Record<DocumentType, string> = {
    ...
    "Debit Note": "border-fuchsia-200 bg-fuchsia-50 text-fuchsia-900",
    "Credit Note": "border-violet-200 bg-violet-50 text-violet-900",
    ...
    "Delivery Challan": "border-sky-200 bg-sky-50 text-sky-900",
      ...
      action={
        <div className="flex flex-col items-end gap-3">
          <div className="flex flex-wrap items-center justify-end gap-3">
            ...
            <Link
              href="/admin/generate-bill/delivery-challan"
              className="inline-flex items-center rounded-xl border border-sky-300 bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-700"
            >
              Delivery Challan
            </Link>
            <Link
              href="/admin/generate-bill/credit-note"
              className="inline-flex items-center rounded-xl border border-violet-300 bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-violet-700"
            >
              Credit Note
            </Link>
            <Link
              href="/admin/generate-bill/debit-note"
              className="inline-flex items-center rounded-xl border border-fuchsia-300 bg-fuchsia-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-fuchsia-700"
            >
              Debit Note
            </Link>
          </div>
